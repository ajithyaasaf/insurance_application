...
export const createClaimSchema = z.object({
    body: z.object({
        ...
        claimAmount: z.number().min(0, 'Claim amount must be valid').optional().nullable(),
        estimatedAmount: z.number().min(0, 'Estimated amount must be valid').optional().nullable(),
        billAmount: z.number().min(0, 'Bill amount must be valid').optional().nullable(),
...
export const updateClaimSchema = z.object({
    body: z.object({
        ...
        claimNumber: z.string().optional().or(z.literal('')),
        claimAmount: z.number().min(0).optional().nullable(),
        estimatedAmount: z.number().min(0).optional().nullable(),
        billAmount: z.number().min(0).optional().nullable(),
