...
export const createPolicySchema = z.object({
    body: z.object({
        ...
        policyType: z.enum(['motor', 'health', 'life', 'fire', 'marine', 'travel', 'property', 'liability', 'other']),
        ...
        premiumMode: z.enum(['yearly', 'half_yearly', 'quarterly', 'monthly', 'single']).optional(),
        ...
        paymentMethod: z.enum(['cash', 'cheque', 'online', 'card']).optional(),
...
export const updatePolicySchema = z.object({
    body: z.object({
        ...
        policyNumber: z.string().optional().or(z.literal('')),
        policyType: z.enum(['motor', 'health', 'life', 'fire', 'marine', 'travel', 'property', 'liability', 'other']).optional(),
        vehicleNumber: z.string().optional().or(z.literal('')),
