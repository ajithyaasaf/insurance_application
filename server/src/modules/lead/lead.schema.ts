...
export const convertLeadSchema = z.object({
    ...
    body: z.object({
        ...
        policyType: z.enum(['motor', 'life', 'health']).optional(),
        ...
        registrationDate: z.string().optional().nullable(),
        vehicleClass: z.enum(['TW', 'PCV', 'PVT', 'GCV', 'Misc_D', 'CPM', 'Fire', 'Public_Liability', 'SAOD_TW', 'SAOD_PVT', 'CPA', 'Home_Insurance', 'Others']).optional().nullable(),
