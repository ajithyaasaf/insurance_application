...
export class ClaimController {
    ...
    async findAll(req: Request, res: Response, next: NextFunction) {
        try {
            ...
            const result = await claimService.findAll(req.user!.userId, req.user!.role, +page || 1, +limit || 20, search, status, vehicleClass);
    ...
    async findById(req: Request, res: Response, next: NextFunction) {
        try {
            const claim = await claimService.findById(req.user!.userId, req.user!.role, req.params.id as string);
    ...
    async update(req: Request, res: Response, next: NextFunction) {
        try {
            const claim = await claimService.update(req.user!.userId, req.user!.role, req.params.id as string, req.body);
    ...
    async delete(req: Request, res: Response, next: NextFunction) {
        try {
            await claimService.delete(req.user!.userId, req.user!.role, req.params.id as string);
